...
/skills - добавление скилов для проектов
/projects - показывает твои проекты
/delete - даёт возможность удалить какой-то из своих проектов
/update_projects - используется для обновления твоих проектов
